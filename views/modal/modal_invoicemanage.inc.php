                ...
                <form id="form_invManage" method='post' action='' enctype="multipart/form-data">
                    ...
                    <fieldset style="margin-bottom:30px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <input type="text" id="p_discout_price" class="form-control" placeholder="ส่วนลด (บาท)">
                            </div>
                            <div class="col-lg-2">
                    ...
                    <table class="table" id="productList">
                        ...
                        <tr class="table-secondary">
                            ...
                            <th scope="col" style="width: 15%; font-size: 12px;" class="text-center">ส่วนลด (บาท)</th>
                            <th scope="col" style="width: 20%; font-size: 12px;" class="text-center">รวมเป็นเงิน (บาท)</th>
