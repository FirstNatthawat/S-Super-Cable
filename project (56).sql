...
--
-- Host: localhost:3306
-- Generation Time: Dec 09, 2021 at 04:38 AM
...
(1, '111', '111', 1, '2', '1111111111', '1111111111@1111.com', '1111111111111', 50000, '3เดือน', 1, '-', 'ใช่', 'test', NULL),
(33336, '003', '003', 2, NULL, '0999999999', '003@g.com', '0123456789123', 10000000, '45 วัน', 2, '-', 'ไม่ใช่', '-', NULL),
(33339, '0003', 'test', 17, '204', '1234567890', 'Natthawat.Suetrong@gmail.com', '3333333333333', 10000, '3 เดือน', 1, '-', 'ไม่ใช่', '-', NULL);
...
('a001', 'Admin', 'Admin', 'Admin', '4e7afebcfbae000b22c7c85e5560f89a2a0280b4', 'Admin@hotmail.com', 'e1c5155c288e184f85f630505f067b96cfabc131.jpg', 'Admin', 0),
...
--
ALTER TABLE `award`
  MODIFY `ID_Award` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20211205154859;
...
--
ALTER TABLE `borroworreturn`
  MODIFY `ID_BorrowOrReturn` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `company`
  MODIFY `ID_Company` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33340;
...
--
ALTER TABLE `invoice_detail`
  MODIFY `ID_Invoice_Detail` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `message`
--
ALTER TABLE `message`
  MODIFY `ID_Message` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20211205160435;
...
--
ALTER TABLE `promotion`
  MODIFY `ID_Promotion` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `sales`
  MODIFY `ID_Excel` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `zone`
  MODIFY `ID_Zone` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `company`
  ADD CONSTRAINT `company_ibfk_1` FOREIGN KEY (`ID_Employee`) REFERENCES `employee` (`ID_Employee`),
...
--
ALTER TABLE `goods`
  ADD CONSTRAINT `goods_ibfk_1` FOREIGN KEY (`ID_Goods`) REFERENCES `invoice_detail` (`ID_Goods`);
...
ALTER TABLE `message_status`
  ...
  ADD CONSTRAINT `message_status_ibfk_2` FOREIGN KEY (`ID_Employee`) REFERENCES `employee` (`ID_Employee`);
